...
Above ones are NOT available for part time or during probation time.
 - Travel insurance for business trips (worldwide, basic sport included, charged / day). You have to send a notification email to utas.keretnap@viennalife.hu at least one workday before your trip. The notification should include the name of the traveller, the date and destionation countries. You have to travel with your insurance plastic card, which you can get from the Admin role.
